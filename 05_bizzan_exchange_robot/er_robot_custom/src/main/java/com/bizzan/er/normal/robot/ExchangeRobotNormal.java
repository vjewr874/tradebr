...
public class ExchangeRobotNormal implements Runnable, IExchangeRobot{
	...
	protected String currenOrderURL = "http://49.234.13.106:8801/exchange/order/mockcurrentydhdnskd";
	protected String cancelOrderURL = "http://49.234.13.106:8801/exchange/order/mockcancelydhdnskd";
	protected String exchangeTYPE = "LIMIT_PRICE";
	protected String directionSELL = "SELL";
	protected String commitOrderURL = "http://49.234.13.106:8801/exchange/order/mockaddydhdnskd";
	protected String plateURL = "http://49.234.13.106:8801/market/exchange-plate-mini";
