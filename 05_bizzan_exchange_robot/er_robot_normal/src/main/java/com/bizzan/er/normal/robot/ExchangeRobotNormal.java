...
public class ExchangeRobotNormal implements Runnable, ExchangeRobot{
	...
	protected String currenOrderURL = "http://172.19.0.8:8801/exchange/order/mockcurrentydhdnskd";
	protected String cancelOrderURL = "http://172.19.0.8:8801/exchange/order/mockcancelydhdnskd";
	protected String exchangeTYPE = "LIMIT_PRICE";
	protected String directionSELL = "SELL";
	protected String commitOrderURL = "http://172.19.0.8:8801/exchange/order/mockaddydhdnskd";
	protected String plateURL = "http://172.19.0.8:8801/market/exchange-plate-mini";
